...
import { Avatar, Box, CardActionArea, CardContent, CardMedia, Grid, Typography } from "@mui/material";
                         ...
                         <CardActionArea className=' mt-5  my-1' >
                              <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }} >
                                   <Grid item xs={12} lg={6}>
                                        ...
                                        >
                                             <Image src={data.image_url} className='rounded-md' width={800} height={200} alt='image' />
                                        </CardMedia>
                                   </Grid>
                                   <Grid  item xs={12} lg={6}>
                                        <CardContent>

                                             <Typography className=' font-semibold text-gray-500 text-xl' gutterBottom variant="h4" component="div">
                                                  {data.title}
                                             </Typography>
                                             <Box className="text-gray-400 py-1"
                                                  sx={{
                                                       display: "flex",
                                                       gap: 1,
                                                       alignItems: "center",
